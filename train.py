...
def main():
    ...
    parser.add_argument('--image_label_test','-ilt', help='Path to training image-label list file')
    ...
    if comm.rank == 0:
        ...
        test=DeepFashionBboxDataset(args.bbox_test,args.image_label_test, args.image_root)
